  ...
  return (
    <section className="w-full bg-[var(--bg-primary)] py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        {/* Section Header */}
        <div className="mb-16">
          <h2 className="text-4xl sm:text-5xl font-bold text-[var(--text-heading)] mb-4">
            {culture_title}
          </h2>
          <p className="text-lg text-[var(--text-base)] max-w-3xl">
            {culture_description}
          </p>
        </div>
        ...
        <div className="border-t border-gray-700 pt-12 mt-12">
          <p className="text-center text-[var(--text-base)] max-w-2xl mx-auto">
